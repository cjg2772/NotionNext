...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.lcyteam.tech', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'LCY Team, Blog', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://image.lcyteam.tech/file/c45da08882e745e9be273.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
